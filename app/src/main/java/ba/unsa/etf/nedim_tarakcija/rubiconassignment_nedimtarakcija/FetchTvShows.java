...
public class FetchTvShows extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        String link​ = "https://api.themoviedb.org/3/tv/top_rated?api_key=e768697e64a1a5079ec23d9fc0f150d7&language=en-US&page=1";
        try {
            ...
            bundle.putSerializable("movies", shows);
            bundle.putString("for", "show");
